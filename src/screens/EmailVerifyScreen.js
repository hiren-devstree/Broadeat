        ...
        <View1CC {...this.props} >
          ...
          <View style={styles.bottomContainer}>
            <View style={{ flexDirection: 'row' }}>
              <CText style={{ margin: 30 }} fontSize={StyleConfig.countPixelRatio(16)}>Have an account?<Text onPress={() => this.props.navigation.navigate('Login')} style={{ color: "#2294E3", }}>  Log in         </Text></CText>
            </View>
          </View>
        </View1CC>
      </SafeAreaView>
